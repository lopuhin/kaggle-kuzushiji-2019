...
python -m kuzushiji.classify.level2_features _runs/clf-fold0/detailed.csv.gz _runs/v100-clf-fold0-wsl16d-mt256-frozen-start/detailed.csv.gz                                                              _runs/level2_train_v5_fold0.csv.gz
...
python -m kuzushiji.classify.level2 _runs/clf-fold[0-4]/detailed.csv.gz _runs/level2_train_v5_fold[0-4].csv.gz --save-model bst-v5

python -m kuzushiji.classify.level2 _runs/clf-fold0/test_detailed.csv.gz  \
    level2_test_v2_fold01234-wsl16-fold0-wsl8-fold1234-pseudo-ft-fold1234.csv.gz \
    --load-model bst-v5 \
    --output level2_test_v2_fold01234-wsl16-fold0-wsl8-fold1234-pseudo-ft-fold1234_nbr50_fold0.csv.gz --n-folds 1

python -m kuzushiji.classify.level2 _runs/clf-fold0/test_detailed.csv.gz  \
    level2_test_v2_fold01234-wsl16-fold0-wsl8-fold1234-pseudo-ft-fold1234.csv.gz \
    --load-model bst-v5 \
    --output level2_test_v2_fold01234-wsl16-fold0-wsl8-fold1234-pseudo-ft-fold1234_nbr50_blend.csv.gz
